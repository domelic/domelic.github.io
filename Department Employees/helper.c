...
/*
 ...
 This is important so that the compiler correctly reserves the needed space in memory.
 You won't be able to use these arrays otherwise.
 
 Usage:
 int array[rowSize][columnSize];
 initialize2DArray((int *)array, rowSize, columnSize);
 */
void initialize2DArray(int *array, size_t rowSize, size_t columnSize) {
    int row, column;
...
/*
 Convenient method to print integer 2D arrays.
